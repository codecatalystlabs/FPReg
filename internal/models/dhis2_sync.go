...
type DHIS2MappingItem struct {
	...
	LocalIndicatorKey     string    `gorm:"size:100;uniqueIndex;not null" json:"local_indicator_key"`
	...
	DHIS2DataElementUID   string    `gorm:"size:64" json:"dhis2_dataelement_uid"` // nullable – required for active rows
	DHIS2CatOptionComboUID string   `gorm:"size:64" json:"dhis2_categoryoptioncombo_uid"`
